...
function Sidebar({ sidebarOpen, onClose }) {
  ...
  const navItems = [
    ...
    {
      text: "Work Schedules",
      path: "/admin/payroll/work-schedules",
      roles: ["Admin"],
      icon: <LockClockIcon />,
      group: "Payroll",
      feature: "payroll",
    ...
    {
      text: "Allowance Types",
      path: "/admin/payroll/allowance-types",
      roles: ["Admin"],
      icon: <CalculateOutlinedIcon />,
      group: "Payroll",
      feature: "payroll",
    ...
    {
      text: "Bonus Tiers",
      path: "/admin/payroll/bonus-tiers",
      roles: ["Admin"],
      icon: <AnalyticsIcon />,
      group: "Payroll",
      feature: "payroll",
    ...
    {
      text: "APIT (PAYE) Slabs",
      path: "/admin/payroll/apit-slabs",
      roles: ["Admin"],
      icon: <QueryStatsIcon />,
      group: "Payroll",
      feature: "payroll",
    ...
    {
      text: "Gratuity Report",
      path: "/admin/payroll/gratuity",
      roles: ["Admin"],
      icon: <WorkHistoryIcon />,
      group: "Payroll",
      feature: "payroll",
    ...
    {
      text: "Employee Bank Details",
      path: "/admin/payroll/employee-bank",
      roles: ["Admin"],
      icon: <AssessmentOutlinedIcon />,
      group: "Payroll",
      feature: "payroll",
    ...
    {
      text: "Company Config",
      path: "/admin/payroll/company-config",
      roles: ["Admin"],
      icon: <ToggleOnIcon />,
      group: "Payroll",
      feature: "payroll",
