...
# Serve /media/ from the backend regardless of DEBUG.
# The stock static() helper is a no-op when DEBUG=False, which broke
# reference-photo fetches (and mobile punch-in) in production.
urlpatterns += [
    re_path(
        r'^media/(?P<path>.*)$',
        static_serve,
